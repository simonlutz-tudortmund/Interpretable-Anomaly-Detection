                ...
                for lb, ub, case_name in boundary_cases:
                    log_file = str(
                        base_folder.joinpath(
                            "logs",
                            f"{case_name}_{max_sequence_length}_states{num_states}_{seed}.log",
                        )
                    )
                    dfa_file = str(
                        base_folder.joinpath(
                            "dfas",
                            f"{case_name}_{max_sequence_length}_states{num_states}_{seed}",
                        )
                    )
                    log_file_gurobi = str(
                        base_folder.joinpath(
                            "gurobi_logs",
                            f"{case_name}_{max_sequence_length}_states{num_states}_{seed}_gurobi.log",
                        )
                    )
