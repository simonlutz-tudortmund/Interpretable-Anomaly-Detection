                ...
                for lb, ub, case_name in boundary_cases:
                    log_file = str(
                        base_folder.joinpath(
                            "logs",
                            f"{class_a}-{class_b}_states{num_states}_{case_name}_{seed}.log",
                        )
                    )
                    dfa_file = str(
                        base_folder.joinpath(
                            "dfas",
                            f"{class_a}-{class_b}_states{num_states}_{case_name}_{seed}",
                        )
                    )
                    log_file_gurobi = str(
                        base_folder.joinpath(
                            "gurobi_logs",
                            f"{class_a}-{class_b}_states{num_states}_{case_name}_gurobi_{seed}.log",
                        )
                    )
